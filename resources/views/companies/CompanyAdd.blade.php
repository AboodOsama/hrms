...
@section('content')
    <div class="container-fluid">
        <div class="col-xl-8">
            <form class="card" method="POST" enctype="multipart/form-data" action="{{ url('/company/store') }}">
                @csrf
                <div class="card-header">
                    <h4 class="card-title mb-0">إضافة شركة</h4>
                ...
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input name="name" class="form-control" type="text" placeholder="اسم الشركة"
                                        required>
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input name="address" class="form-control" type="text"
                                        placeholder="مقر المركز الرئيس للشركة" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input name="recipient" class="form-control" type="text"
                                        placeholder="اسم مسؤول الموارد البشرية في الشركة">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                    ...
                    <div class="card-footer text-end">
                        <input class="btn btn-primary" type="submit" value="إضافة شركة">
                    </div>
                </div>
            </form>
        </div>
